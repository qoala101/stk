...
TEST(FinanceApi, GetCandlesticks) {
  const auto candlesticks = stonks::finance::GetCandlesticks(
      ...
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 2022 23:59:59"));
...
TEST(FinanceApi, GetCandlesticksMoreThan1000) {
  auto candlesticks = stonks::finance::GetCandlesticks(
      ...
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 2022 00:00:00"),
      *stonks::utils::GetUnixTimeMillisFromString("2 Apr 2022 23:59:59"));
...
TEST(FinanceApi, GetCandlesticksWrongDates) {
  auto candlesticks = stonks::finance::GetCandlesticks(
      ...
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 2022 00:00:00"),
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 2122 23:59:59"));
  EXPECT_FALSE(candlesticks.has_value());

  candlesticks = stonks::finance::GetCandlesticks(
      "ETHUSDT", stonks::finance::Interval::k1Minute,
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 3000 00:00:00"),
      *stonks::utils::GetUnixTimeMillisFromString("1 Apr 3000 23:59:59"));
  EXPECT_FALSE(candlesticks.has_value());
}
